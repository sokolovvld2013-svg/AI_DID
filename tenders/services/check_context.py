...
- Указывай конкретные нормы (статьи 135-ФЗ, пункты Приказа ФАС № 147/23) **только** если уверен в номере и содержании; иначе ссылайся на акт в целом без пункта и без цифры.
