...
Каждая категория замечаний — ОДИН непрерывный список со сквозной нумерацией (1., 2., 3., … до конца категории). ЗАПРЕЩЕНО:
- начинать список заново;
- повторять заголовок категории или добавлять пометки «(продолжение)»;
- дробить категорию на несколько блоков.
Даже если пунктов очень много — продолжай нумерацию под тем же единственным заголовком 🔴 или 🟡. Замечание не считается отдельным, пока у него нет нового номера.
